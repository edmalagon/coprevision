                                                                                                                                                              ...
                                                                                                                                                              function ocultarTexto16() {
                                                                                                                                                                      ...
                                                                                                                                                                      genital.onreadystatechange=leerArchivo17; //indicar dónde recoger la respuesta
                                                                                                                                                                        ...
                                                                                                                                                                        function ocultarTexto17() {
                                                                                                                                                                                ...
                                                                                                                                                                                evorehpredeterminada=creaObjetoAjax(); //llamar a funcion crear objeto.
                                                                                                                                                                                evorehpredeterminada.open("GET","textos/evorehpredeterminada.txt",true); //preparar petición del objeto
                                                                                                                                                                                evorehpredeterminada.onreadystatechange=leerArchivo17; //indicar dónde recoger la respuesta
                                                                                                                                                                                  evorehpredeterminada.send() //enviar petición
                                                                                                                                                                                  //función que recoge la respuesta para poder utilizarla
                                                                                                                                                                                  function leerArchivo17() {
                                                                                                                                                                                          if (evorehpredeterminada.readyState == 4) { //Comprobar carga página
                                                                                                                                                                                              if (evorehpredeterminada.status == 200) { //Comprobar URL
                                                                                                                                                                                                texto18=evorehpredeterminada.responseText; //Recoger texto
                                                                                                                                                                                              }
                                                                                                                                                                                             }
                                                                                                                                                                                          }
                                                                                                                                                                                  //función para botón "Ver texto"
